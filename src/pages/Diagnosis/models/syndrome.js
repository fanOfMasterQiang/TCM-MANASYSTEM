import { queryKey, addSyn, changeSyn, delSyn} from '@/services/diagnosis/syndrome';
...
export default {
  ...
  effects: {
    ...
    *addData({ payload, callback }, { call }) {
      yield call(addSyn, payload);
      if (callback) callback();
    },
    *removeData({ payload, callback }, { call }) {
      yield call(delSyn, payload);
      if (callback) callback();
    },
    *updateData({ payload, callback }, { call }) {
      yield call(changeSyn, payload);
      if (callback) callback();
    },
